...
class UsersListItem extends React.Component {
  ...
  render() {
    return <li>
      ...
      <button onClick={this.handleRoleClick.bind(this, 1)}>Admin</button>
      <button onClick={this.handleRoleClick.bind(this, 2)}>User</button>
      <button onClick={this.handleRoleClick.bind(this, 3)}>Customer</button>
    </li>
  }
}
